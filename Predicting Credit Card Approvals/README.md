...
The dataset used in this project is the Credit Card Approval dataset from the UCI Machine Learning Repository with dependencies such as sklearn, numpy, and pandas. 
